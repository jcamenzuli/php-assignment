<?php
    ...
    // This line specifes header commands we can use.
    ...
    header('Acces-Control-Allow-Methods: GET, DELETE, OPTIONS, PATCH, POST, PUT');
    ...
    function check_login_auth()
    {
        ...
        return chech_api_auth($id, $auth);
    }

    // This function will format an error that we can use in the app.
    function error($message = "The server could not process your request due to an unkown error.")
    {
    ...
    function get_input_stream(&$data)
    {
        ...
        // We will read it and send it back to the origina; page.
